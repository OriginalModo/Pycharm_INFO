...
#
#
# asyncio.sleep(0) - Оператор заставляет функцию отложить выполнение и дать циклу событий возможность выполнить другие задачи
#
#
#
# модель joblib основан на библиотеке Loky (которая сама по себе являтеся улучшенной версией concurrent.futures) и в ней
# используется модуль cloudpickle, дающий возможность отбирать функции, определенные в интерактивной оболочке
...
"""
Если вы занимаетесь обработкой регулярных выражений или другими задачами сопоставление с образцом, я настоятельно
рекомедую изучить различных варианты префиксных и суффиксных алгоритмов
"""
